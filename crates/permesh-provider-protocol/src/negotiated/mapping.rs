...
fn identity_status(value: IdentityStatus) -> permesh_core::IdentityStatus {
    match value {
        ...
        IdentityStatus::Suspended => permesh_core::IdentityStatus::Suspended,
...
fn certainty(value: Certainty) -> permesh_core::Certainty {
    match value {
        ...
        Certainty::Derived => permesh_core::Certainty::Derived,
...
fn affiliation(value: Affiliation) -> permesh_core::Affiliation {
    match value {
        Affiliation::Internal => permesh_core::Affiliation::Internal,
        Affiliation::External => permesh_core::Affiliation::External,
        Affiliation::Unknown => permesh_core::Affiliation::Unknown,
    }
}
fn evidence_kind(value: EvidenceKind) -> permesh_core::EvidenceKind {
    match value {
        EvidenceKind::Permission => permesh_core::EvidenceKind::Permission,
        EvidenceKind::Assignment => permesh_core::EvidenceKind::Assignment,
        EvidenceKind::PolicyAttachment => permesh_core::EvidenceKind::PolicyAttachment,
        EvidenceKind::Unknown => permesh_core::EvidenceKind::Unknown,
    }
}
...
pub(crate) fn resource(value: Resource) -> permesh_core::Resource {
    permesh_core::Resource {
        kind: value.kind,
        parent: value.parent.map(entity_key),
        key: entity_key(value.key),
        name: value.name,
    }
}
