...
`negotiated_v1` instances use operation-negotiated negotiated protocol 1 for discovery and health. Approval binds the selected provider context
...
SDK until their protocol-1 emitter has been implemented and qualified. The opt-in
[negotiated contract](provider-protocol/negotiated-v1.md) can transmit these
