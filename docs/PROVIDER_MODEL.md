...
External provider protocol is specified in `provider-development.md`; executable loading is deferred. No empty official AWS/Google/Cloudflare crates are created.
