...
7. **Explicit native discovery implemented** — External providers: bounded framing, strict capability/envelope validation, Python-to-Rust fixtures, user-local digest registration and native process supervision. Workspace query integration, interpreted providers and credential transport remain deferred.
